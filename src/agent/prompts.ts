...
- For whether a gate is closed, the current evidence/gates entry and exact release receipts override historical target or baseline prose. If performance prose says no G7 passed while evidence/gates records G7 closed, treat that prose as stale for closure status, preserve it as a surfaced conflict, and do not claim that G7 is open.
